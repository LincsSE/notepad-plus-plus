...
// IMPORTANT: If list below is modified, you have to change the value of IDM_FILEMENU_LASTONE and IDM_FILEMENU_EXISTCMDPOSITION
	...
	#define	   IDM_FILE_CLOSEALLSAVED			(IDM_FILE + 6)
    #define    IDM_FILE_SAVE                    (IDM_FILE + 7) 
    #define    IDM_FILE_SAVEALL                 (IDM_FILE + 8) 
    #define    IDM_FILE_SAVEAS                  (IDM_FILE + 9)
    #define    IDM_FILE_CLOSEALL_TOLEFT         (IDM_FILE + 10)
    #define    IDM_FILE_PRINT                   (IDM_FILE + 11)
